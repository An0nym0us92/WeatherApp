...
def data_get():
    city = city_name.get()
    data =requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=3883335e55408bff0142e99b0b9bcb21").json()    
    w_label1.config(text=(data["weather"][0]["main"]).capitalize())
    wb_label1.config(text=(data["weather"][0]["description"]).capitalize())
...
"""
city_name = "cuttack"
data =requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city_name+"&appid=3883335e55408bff0142e99b0b9bcb21").json()
print(data)
"""
